...
function populate(lootTable as LootTable, tier as int, extra as bool, single as bool) {
	...
	if (extra) {
		...
		thp1.addItemEntry(<asr:skull_giant_sword>, 20, 1, [Functions.setCount(1, 1)], []);
		thp1.addItemEntry(<asr:wooden_shield>, 20, 1, [Functions.setCount(1, 1)], []);
		thp1.addItemEntry(<asr:skull_shield>, 20, 1, [Functions.setCount(1, 1)], []);
		...
		thp1.addItemEntry(<combustfish:bone_fish>, 40, 1, [Functions.setCount(1, 1)], []);
	}
	...
	thp2.addItemEntry(<asr:netherquartz_giant_sword>, 30, 1, [Functions.setCount(1, 1)], []);
	thp2.addItemEntry(<asr:gilded_stone_shield>, 30, 1, [Functions.setCount(1, 1)], []);
	thp2.addItemEntry(<asr:gilded_iron_shield>, 30, 1, [Functions.setCount(1, 1)], []);
	...
	if (tier >= 2) {
		...
		thp3.addItemEntry(<asr:ender_giant_sword>, 15, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<asr:gilded_netherquartz_shield>, 15, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<asr:diamond_shield>, 15, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<asr:ender_shield>, 15, 1, [Functions.setCount(1, 1)], []);
		...
		thp3.addItemEntry(<hexxitworld:boomerang>, 10, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:mirror>, 10, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:mystic_seed>, 10, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:phoenix_feather>, 25, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:earth_medallion>, 12, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:fire_medallion>, 12, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:ender_medallion>, 12, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:wind_medallion>, 12, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:aero_amulet>, 10, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:geo_amulet>, 10, 1, [Functions.setCount(1, 1)], []);
		thp3.addItemEntry(<hexxitworld:pyro_amulet>, 10, 1, [Functions.setCount(1, 1)], []);
	}
}