...
scripts.loot.hexxit_loot.populate(LootTweaker.getTable("quark:chests/pirate_chest"), 3, false, false);
scripts.loot.hexxit_loot.populate(LootTweaker.getTable("mod_lavacow:chests/cemetery_chest"), 3, false, false);
scripts.loot.hexxit_loot.populate(LootTweaker.getTable("mod_lavacow:chests/desert_tomb_chest"), 3, false, false);
